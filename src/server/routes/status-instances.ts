...
export function parseSavedLocalInstanceConfig(savedVars: Record<string, string>): Partial<DeployResult["config"]> {
  return {
    ...
    agentSourceGitUrl: savedVars.AGENT_SOURCE_GIT_URL || undefined,
    agentSourceGitRef: savedVars.AGENT_SOURCE_GIT_REF || undefined,
    agentSourceGitPath: savedVars.AGENT_SOURCE_GIT_PATH || undefined,
